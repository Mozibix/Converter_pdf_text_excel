...
// //                   Delectus odio porro magnam ut esse odit. Sequi obcaecati,
// //                   laborum sed esse tempora dicta, atque ullam necessitatibus
// //                   velit voluptas quaerat officiis aperiam illum corrupti ea
// //                   temporibus aut officia rem vitae cupiditate. Ipsa incidunt
// //                   nemo nostrum ex maiores laudantium id harum adipisci. Officia?
// //                 </p>
// //                 <p>
// //                   Iure doloremque, exercitationem impedit quo eos animi, autem
// //                   velit et ratione non omnis repudiandae suscipit corrupti
// //                   excepturi nisi aut maxime molestiae nihil fugit libero cumque
// //                   rem officiis voluptates. Commodi, quia nisi hic laudantium
// //                   alias fuga reprehenderit animi tempora perferendis explicabo
// //                   libero distinctio. Et qui eveniet aut, nostrum incidunt ipsam
// //                   eius?
// //                 </p>
// //                 <p>
// //                   Atque sint aperiam reprehenderit? Tempora iure pariatur illum
// //                   dicta quisquam dolorem in laborum minima repudiandae fuga
// //                   repellendus excepturi, quam vel ut recusandae explicabo, illo
// //                   beatae voluptates dolore reiciendis facilis. Aliquam, magnam
// //                   culpa eveniet assumenda fugit eligendi, odit labore beatae
// //                   corrupti laborum suscipit at provident quis omnis quam
// //                   praesentium, reprehenderit alias.
// //                 </p>
// //                 <p>
// //                   Error commodi magnam enim aliquam illum. Illum magni quidem
// //                   quas ullam totam sed aliquam. Sunt optio quasi ratione
// //                   voluptate beatae ipsa molestias quisquam ipsam quo temporibus
// //                   perspiciatis incidunt voluptatibus praesentium nam maxime
// //                   pariatur nesciunt animi, provident reprehenderit vero
// //                   obcaecati harum! Dignissimos ipsum explicabo et cupiditate ab
// //                   minima impedit quia exercitationem.
// //                 </p>
// //                 <p>
// //                   Quis recusandae nobis eius facere perspiciatis explicabo totam
// //                   minima sed voluptas molestiae deleniti hic ad doloribus quae
// //                   sequi mollitia, cumque unde eos. Nihil nostrum illum ratione,
// //                   quibusdam exercitationem eos qui modi atque accusantium, nobis
// //                   iure aliquid perspiciatis ipsam dicta iusto possimus magnam
// //                   doloribus aliquam ducimus quia id? Repudiandae, rem quo!
// //                 </p>
// //               </div>
// //             </Text>
// //           </View>
...
//         Capítulo : Que trata de la condición y ejercicio del famoso hidalgo D.
  ...
  return (
    <div className="text">
      <p>
        ...
        ratione dolorum temporibus accusamus, error necessitatibus voluptatum!
        Hic optio reiciendis sapiente!
      </p>
      <p>
        Accusamus nihil minus harum tenetur, dolor expedita omnis quia nostrum
        explicabo odit doloribus, officia id accusantium ullam. Exercitationem,
        ipsam esse.
      </p>
      <p>
        Itaque veniam voluptatibus repellendus omnis temporibus vitae, iure
        blanditiis fuga, placeat consectetur natus expedita. Doloremque saepe
        dolorum excepturi illum accusantium?
      </p>
      <p>
        Excepturi saepe cum culpa, neque voluptas voluptatem harum molestiae in
        explicabo quos, fuga totam. Dolore fuga eligendi esse temporibus modi?
      </p>
    </div>
  );
};
